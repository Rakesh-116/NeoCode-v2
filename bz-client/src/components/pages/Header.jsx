            ...
            >
                ...
                <div className="hidden lg:flex space-x-6 xl:space-x-8">
                    ...
                    <Link
                        to="/problemset"
                        className={`hover:text-white transition-colors ${
                            location.pathname === "/problemset" ? "text-white" : "text-white/70"
                        }`}
                    >
                        Problems
                    </Link>
                    {isLoggedIn && (
                        <Link
                            to="/courses"
                            className={`hover:text-white transition-colors ${
                                location.pathname === "/courses" ? "text-white" : "text-white/70"
                            }`}
                        >
                            Courses
                        </Link>
                    ...
                    {isLoggedIn && (
                        <Link
                            to="/learning/profile"
                            className={`hover:text-white transition-colors ${
                                location.pathname === "/learning/profile" ? "text-white" : "text-white/70"
                            }`}
                        >
                            Learning
                        </Link>
                ...
                <div className="hidden lg:flex items-center space-x-4">
                    ...
                    >
                        ...
                        <span className="hidden xl:inline text-white/80 font-medium">Open Source</span>
                    </a>
                    {isLoggedIn ? (
